...
\title{Construction of a robust pipeline to estimate 3D trajectories from 2D hand landmarks} 
%compulsory
...
\begin{titlepage}
	...
	\begin{center}
		{\LARGE{
				\setstretch{1.2}
				\textbf{Construction of a robust pipeline to estimate 3D trajectories from 2D hand landmarks}
				\par
		}}
	\end{center}

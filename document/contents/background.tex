...
\begin{Equation}[H]
	...
	\end{equation}
	\caption[Solve the optimization problem for ridge regression.]{The goal is to find the weight $w$ that minimize the cost function $E(w)$.}
\end{Equation}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.7\textwidth]{images/grad_desc}
